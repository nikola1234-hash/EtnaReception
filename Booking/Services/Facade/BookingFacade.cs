...
namespace Booking.Services.Facade
{
    public class BookingFacade : IBookingFacade
    {
                                  ...
                                  GuestWrapper guestWrapper = null)
        {
            ...
            if (isGuestSelected)
            {
                int reservationId = _reservationService.CreateReservation(guestId, searchWrapper.StartDate, searchWrapper.EndDate, totalPrice);
            ...
            {
                var guestForCreation = guestWrapper as object;
